...
function generateCat() {
    ...
    image.src = "https://thecatapi.com/api/images/get?format=src&type=gif&siza=small";
...
function rpsGame(yourChoice) {
    ...
    message = finalMessage(results) // {mwssage: "You won!", "color": "green"}
...
function showCard(card, activePlayer) {
    ...
    cardImage.src = `assets/images/blackjack-images/${card}.png`;
...
function computeWinner() {
    ...
    if (YOU ['score'] <= 21) {
        ...
        // condition when user bust but deale doesnt
